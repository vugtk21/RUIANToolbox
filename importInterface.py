...
"""
Tato procedura by měla vypisovat do konzole obsah parametru message. Vzhledem k
tomu, že jste přesměroval standardní výstup do textového pole, teda aspoň myslím,
tak by nemělo být potřeba na to sahat.
...
""" Procedura, kterou využijeme pro testování, jestli ze stránky vyplnění
parametrů databáze přejít na vytváření databáze nebo přímo na import.
"""
