...
echo ------------------------------------------------------
echo Pro informaci o prubehu importu, sledujte obsah souboru Download.log a ImportRUIANErr.log, pripadne ostatni logovaci soubory v adresari se stazenymi daty.
